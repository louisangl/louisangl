<!-- Bannière : Remplace le lien par une image qui te représente (ex: un réseau de neurones survolant la Terre, une vue satellite, etc.) -->
<p align="center">
...
<p align="center">
  Je construis des modèles d'intelligence artificielle et j'analyse des données complexes, avec un attrait particulier pour les systèmes critiques, la propulsion et l'observation de la Terre.
</p>

---

### 🔭 Ce que je fais en ce moment
- 🚀 **Actuellement** : En train de développer un modèle de maintenance prédictive pour des turbines.
- 🧠 **J'apprends** : Le Deep Learning appliqué à l'imagerie satellite (Computer Vision) et ROS2.
- 👯 **Je cherche à collaborer sur** : Des projets Open Source en Data Science pour l'aérospatial (ex: trajectoires, optimisation).
- 💬 **Pose-moi des questions sur** : Python, Machine Learning, PyTorch, et l'analyse de séries temporelles.
...
![MATLAB](https://img.shields.io/badge/MATLAB-e26004?style=for-the-badge&logo=mathworks&logoColor=white)
